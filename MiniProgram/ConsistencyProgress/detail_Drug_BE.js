// ConsistencyProgress//detail_Drug_BE.js
var app = getApp();
const util = require('../util/util.js');

const GetCond2Info_Drug_BE = require('../config').ConsistencyProgress.GetCond2Info_Drug_BE
const GetList_Drug_BE = require('../config').ConsistencyProgress.GetList_Drug_BE
...
Page({
  ...
  Load_Cond2Info: function () {
    ...
    var param1 = {};
    param1.url = GetCond2Info_Drug_BE;
    var paramData1 = {};
    paramData1.type = -1;
    paramData1.pkey = "";
