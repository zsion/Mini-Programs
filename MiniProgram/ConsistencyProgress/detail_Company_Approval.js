// ConsistencyProgress//detail_Company_Approval.js
var app = getApp();
const util = require('../util/util.js');

const GetCond2Info_Company_Approval = require('../config').ConsistencyProgress.GetCond2Info_Company_Approval
const GetList_Company_Approval = require('../config').ConsistencyProgress.GetList_Company_Approval
Page({
  ...
  Load_Cond2Info: function () {
    ...
    var param1 = {};
    param1.url = GetCond2Info_Company_Approval;
    var paramData1 = {};
    paramData1.type = -1;
    paramData1.pkey = "";
  ...
  Load_List: function () {
    ...
    //取得列表
    var param2 = {};
    param2.url = GetList_Company_Approval;
    var paramData2 = {};
