// ConsistencyProgress//detail_Company_Pass.js
var app = getApp();
const util = require('../util/util.js');

const GetCond2Info_Company_Pass = require('../config').ConsistencyProgress.GetCond2Info_Company_Pass
const GetList_Company_Pass = require('../config').ConsistencyProgress.GetList_Company_Pass
Page({
  ...
  Load_Cond2Info: function () {
    ...
    var param1 = {};
    param1.url = GetCond2Info_Company_Pass;
    var paramData1 = {};
    paramData1.type = -1;
    paramData1.pkey = "";
  ...
  Load_List: function () {
    ...
    //取得列表
    var param2 = {};
    param2.url = GetList_Company_Pass;
    var paramData2 = {};
