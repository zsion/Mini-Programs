// ConsistencyProgress//detail_Company_ToBeEvaluated.js
var app = getApp();
const util = require('../util/util.js');

const GetCond2Info_Company_NeedEvaluate = require('../config').ConsistencyProgress.GetCond2Info_Company_NeedEvaluate
const GetList_Company_NeedEvaluate = require('../config').ConsistencyProgress.GetList_Company_NeedEvaluate
Page({
  ...
  data: {
    ...
    Isbind: "",
    Modal_hidden: true,
    Width_Array: [{ Width: 28 }, { Width: 17 }, { Width: 22 }, { Width: 33 }, { Width: 0 }],
    Name_Array: [],
    Tool_Name_Array: [],
    SubCategoryId: [],
  ...
  Load_Cond2Info: function () {
    ...
    var param1 = {};
    param1.url = GetCond2Info_Company_NeedEvaluate;
    var paramData1 = {};
    paramData1.type = -1;
    paramData1.pkey = "";
  ...
  Load_List: function () {
    ...
    //取得列表
    var param2 = {};
    param2.url = GetList_Company_NeedEvaluate;
    var paramData2 = {};
