// ClinicalRegistration//Main_endpoint.js
var app = getApp();
const util = require('../util/util.js');

const GetMainIndicatorsList = require('../config').ClinicalRegistration.GetMainIndicatorsList
